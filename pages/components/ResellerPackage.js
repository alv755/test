...
function ResellerPackage(props) {
                ...
                <div className="package_prsing_area">
                    <div className="container">
                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-4 col-md-6 col-lg-4" style={{ marginRight: "35rem", padding: "2rem" }}>
                                    ...
                                    <div className="middle_content">
                                        <div className="list">
                                            <ul>
                                                ...
                                                <li>{props.panel1}</li>
                                                <li>{props.storage1}</li>
                                                <li>{props.access1}</li>
                                                <li>{props.bandwidth1}</li>
                                                <li>{props.ssl}</li>
                                                <li>{props.email}</li>
                                                <li>{props.backups}</li>
                                    ...
                                    <div className="middle_content">
                                        <div className="list">
                                            <ul>
                                                ...
                                                <li>{props.panel2}</li>
                                                <li>{props.storage2}</li>
                                                <li>{props.access2}</li>
                                                <li>{props.bandwidth2}</li>
                                                <li>{props.ssl}</li>
                                                <li>{props.email}</li>
                                                <li>{props.backups}</li>
                                                <li>{props.processor}</li>
